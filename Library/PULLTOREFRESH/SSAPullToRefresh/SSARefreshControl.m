...
#define kSSADefaultRefreshTotalPixels 40
...
- (void)resetScrollViewContentInset {
    ...
    [UIView animateWithDuration:0.3f animations:^{
        ...
        self.refreshCircleContainerView.circleView.offsetY = 20;
...
- (SSACircleView *)circleView {
    if (!_circleView) {
        _circleView = [[SSACircleView alloc] initWithFrame:CGRectMake((CGRectGetWidth(self.bounds) - kSSARefreshCircleViewHeight) / 2, 8, kSSARefreshCircleViewHeight, kSSARefreshCircleViewHeight)];
    }
    return _circleView;
}
